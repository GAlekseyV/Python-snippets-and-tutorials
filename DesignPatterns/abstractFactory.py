...
# Note that the way the factory selection is implemented in this example,
# you could pass any argument to the third factory - not necessarily the word 'Futuristic'
